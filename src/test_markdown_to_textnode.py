...
class TestMarkdownToTextNode(unittest.TestCase):
    def test_bold(self):
        node = TextNode('This is a node with **bold** in it.', 'text')
    ...
    def test_no_text(self):
        node = TextNode("This is a node **that** isn't a text node", 'bold')
        expected = [
            TextNode("This is a node **that** isn't a text node", 'bold'),
        ]
        self.assertEqual(split_nodes_delimiter([node], '**', 'bold'), expected)

    def test_all(self):
        node = TextNode('This is a node with **bold** and _italic_ and `code` in it.', 'text')
        nodes = [node]
        delimiters = {
            '_': 'italic',
            '`': 'code',
    ...
    def test_images(self):
        ...
        expected = [
            TextNode('This is text with a link [to boot dev](https://www.boot.dev) and [to youtube](https://www.youtube.com/@bootdotdev) This is text with a ', 'text'),
    ...
    def test_no_images_or_links(self):
        text = "This is text without a link or image."
        node = TextNode(text, 'text')
        nodes = [node]
        nodes = split_nodes_link(nodes)
        nodes = split_nodes_image(nodes)
        expected = [
            TextNode('This is text without a link or image.', 'text'),
        ]
        self.assertEqual(nodes, expected)
